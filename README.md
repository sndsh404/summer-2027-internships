...
The **Added** column is the date a role landed in this repo (`YYYY-MM-DD`), so you can spot what's new. Rows from before this column existed are marked — since those dates weren't tracked.
